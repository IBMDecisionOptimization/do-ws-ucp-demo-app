...
inputs = {};
outputs = {};
inputs["NurseVacations"] = pd.read_csv("NurseVacations.csv")
inputs["SkillsRequirements"] = pd.read_csv("SkillsRequirements.csv")
inputs["Departments"] = pd.read_csv("Departments.csv")
inputs["NurseSkills"] = pd.read_csv("NurseSkills.csv")
inputs["Skills"] = pd.read_csv("Skills.csv")
inputs["Shifts"] = pd.read_csv("Shifts.csv")
inputs["NurseAssociations"] = pd.read_csv("NurseAssociations.csv")
inputs["NurseIncompatibilities"] = pd.read_csv("NurseIncompatibilities.csv")
inputs["Nurses"] = pd.read_csv("Nurses.csv")
