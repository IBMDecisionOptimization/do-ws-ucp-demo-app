...
inputs = {};
outputs = {};
inputs["Months"] = pd.read_csv("Months.csv")
inputs["InitialInventory"] = pd.read_csv("InitialInventory.csv")
inputs["Markets"] = pd.read_csv("Markets.csv")
inputs["PlantProductCost"] = pd.read_csv("PlantProductCost.csv")
inputs["PlantMonthCapacity"] = pd.read_csv("PlantMonthCapacity.csv")
inputs["PlantProductCapacity"] = pd.read_csv("PlantProductCapacity.csv")
inputs["Plants"] = pd.read_csv("Plants.csv")
inputs["Products"] = pd.read_csv("Products.csv")
inputs["FirmSales"] = pd.read_csv("FirmSales.csv")
inputs["Demand"] = pd.read_csv("Demand.csv")
inputs["MarginalProfit"] = pd.read_csv("MarginalProfit.csv")
inputs["parameters"] = pd.read_csv("parameters.csv")
